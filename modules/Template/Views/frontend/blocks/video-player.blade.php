<div class="gradient-overlay-half-bg-grayish-blue bg-img-hero space-3 space-top-lg-4 space-bottom-lg-3" @if(!empty($bg_image)) style="background-image: url({{get_file_url($bg_image,'full')}});" @endif>
