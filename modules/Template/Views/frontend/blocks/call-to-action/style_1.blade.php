<div class="bravo-call-to-action banner-block banner-v1 bg-img-hero space-3 {{$style}}" @if(!empty($bg_image_url)) style="background-image: url({{ $bg_image_url ?? "" }}) !important;" @endif>
