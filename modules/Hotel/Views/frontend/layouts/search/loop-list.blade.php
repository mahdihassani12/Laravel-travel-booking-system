                ...
                <div class="w-100 position-relative m-4 m-md-0">
                    ...
                    <div class="card-body p-0">
                        ...
                        @if(!empty($translation->badge_tags))
                            <ul class="list-unstyled d-flex pb-2">
                                @foreach($translation->badge_tags as $key => $item)
                                    <li class="border border-{{$item['color']}} bg-{{$item['color']}} rounded-xs d-flex align-items-center text-lh-1 py-1 px-3 mb-2 mb-md-0 mr-2">
