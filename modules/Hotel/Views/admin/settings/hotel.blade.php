                    ...
                    <div class="form-group d-none">
                        ...
                        <div class="form-controls">
                            <select name="hotel_layout_search" class="form-control" >
                                ...
                                <option value="map" {{($settings['hotel_layout_search'] ?? '') == 'map' ? 'selected' : ''  }}>{{__('Map Layout')}}</option>
                            </select>
                        </div>
                    </div>
                @endif
                <div class="form-group d-none">
                    ...
                    <div class="form-controls">
                        <select name="hotel_layout_map_option" class="form-control">
                            <option {{ (setting_item_with_lang('hotel_layout_map_option',request()->query('lang')) ?? '') == 'map_left' ? 'selected' : '' }} value="map_left">{{__('Map Left')}}</option>
                            <option {{ (setting_item_with_lang('hotel_layout_map_option',request()->query('lang')) ?? '') == 'map_right' ? 'selected' : ''  }} value="map_right">{{__("Map Right")}}</option>
                        </select>
                    </div>
                </div>
                @if(is_default_lang())
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <input type="number" min="1" name="hotel_page_limit_item" placeholder="{{ __("Default: 9") }}" value="{{setting_item_with_lang('hotel_page_limit_item',request()->query('lang'), 9)}}" class="form-control">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 d-none">
                            <div class="form-group ">
                                <label class="" >{{__("Layout Item Hotel In Page Search")}}</label>
                                <div class="form-controls">
                                    <select name="hotel_layout_item_search" class="form-control" >
                                        <option value="list" {{($settings['hotel_layout_item_search'] ?? '') == 'list' ? 'selected' : ''  }}>{{__('List Item')}}</option>
                                        <option value="grid" {{ ($settings['hotel_layout_item_search'] ?? '') == 'grid' ? 'selected' : ''  }}>{{__("Grid Item")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-controls">
                            <select name="hotel_location_search_style" class="form-control">
                                ...
                                <option {{ ($settings['hotel_location_search_style'] ?? '') == 'autocomplete' ? 'selected' : '' }} value="autocomplete">{{__('Autocomplete from locations')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group d-none">
                    ...
                    <div class="tab-content" >
                        <div class="tab-pane active" id="seo_1">
                            <div class="form-group" >
                                ...
                                <input type="text" name="hotel_page_list_seo_title" class="form-control" placeholder="{{__("Enter title...")}}" value="{{ setting_item_with_lang('hotel_page_list_seo_title',request()->query('lang'))}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Seo Description")}}</label>
                                <input type="text" name="hotel_page_list_seo_desc" class="form-control" placeholder="{{__("Enter description...")}}" value="{{setting_item_with_lang('hotel_page_list_seo_desc',request()->query('lang'))}}">
                            </div>
                            @if(is_default_lang())
                        ...
                        <div class="tab-pane" id="seo_2">
                            <div class="form-group">
                                ...
                                <input type="text" name="hotel_page_list_seo_share[facebook][title]" class="form-control" placeholder="{{__("Enter title...")}}" value="{{$seo_share['facebook']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Facebook Description")}}</label>
                                <input type="text" name="hotel_page_list_seo_share[facebook][desc]" class="form-control" placeholder="{{__("Enter description...")}}" value="{{$seo_share['facebook']['desc'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                        ...
                        <div class="tab-pane" id="seo_3">
                            <div class="form-group">
                                ...
                                <input type="text" name="hotel_page_list_seo_share[twitter][title]" class="form-control" placeholder="{{__("Enter title...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Twitter Description")}}</label>
                                <input type="text" name="hotel_page_list_seo_share[twitter][desc]" class="form-control" placeholder="{{__("Enter description...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config review for hotel')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                        ...
                        <div class="form-controls">
                            ...
                            <div class="row">
                                @foreach($status as $item)
                                    <div class="col-md-4">
                                        <label><input type="checkbox" name="hotel_allow_review_after_making_completed_booking[]" @if(in_array($item,$settings_status)) checked @endif value="{{$item}}"  /> {{booking_status_to_text($item)}} </label>
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="form-group-item">
                                ...
                                <div class="g-items">
                                    ...
                                    @foreach($social_share as $key=>$item)
                                        <div class="item" data-number="{{$key}}">
                                            <div class="row">
                                                <div class="col-md-11">
                                                    <input type="text" name="hotel_review_stats[{{$key}}][title]" class="form-control" value="{{$item->title}}" placeholder="{{__('Eg: Service')}}">
                                                </div>
                                                <div class="col-md-1">
                                ...
                                <div class="g-more hide">
                                    <div class="item" data-number="__number__">
                                        <div class="row">
                                            <div class="col-md-11">
                                                <input type="text" __name__="hotel_review_stats[__number__][title]" class="form-control" value="" placeholder="{{__('Eg: Service')}}">
                                            </div>
                                            <div class="col-md-1">
                                                <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                                            </div>
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Config buyer fees for hotel')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                                ...
                                @foreach($hotel_booking_buyer_fees as $key=>$buyer_fee)
                                    <div class="item" data-number="{{$key}}">
                                        <div class="row">
                                                ...
                                                @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                                    @foreach($languages as $language)
                                                        ...
                                                        <div class="g-lang">
                                                            ...
                                                            <input type="text" name="hotel_booking_buyer_fees[{{$key}}][name{{$key_lang}}]" class="form-control" value="{{$buyer_fee['name'.$key_lang] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                            <input type="text" name="hotel_booking_buyer_fees[{{$key}}][desc{{$key_lang}}]" class="form-control" value="{{$buyer_fee['desc'.$key_lang] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                        </div>

                                                    @endforeach
                                                @else
                                                    <input type="text" name="hotel_booking_buyer_fees[{{$key}}][name]" class="form-control" value="{{$buyer_fee['name'] ?? ''}}" placeholder="{{__('Fee name')}}">
                                                    <input type="text" name="hotel_booking_buyer_fees[{{$key}}][desc]" class="form-control" value="{{$buyer_fee['desc'] ?? ''}}" placeholder="{{__('Fee desc')}}">
                                                @endif
                                            </div>
                                            <div class="col-md-3">
                                                <input type="number" min="0" step="0.1"  name="hotel_booking_buyer_fees[{{$key}}][price]" class="form-control" value="{{$buyer_fee['price']}}">
                                                <select name="hotel_booking_buyer_fees[{{$key}}][unit]" class="form-control">
                                            ...
                                            <div class="col-md-3">
                                                <select name="hotel_booking_buyer_fees[{{$key}}][type]" class="form-control d-none">
                                                    <option @if($buyer_fee['type'] ==  'one_time') selected @endif value="one_time">{{__("One-time")}}</option>
                                                </select>
                                                <label>
                                                    <input type="checkbox" min="0" name="hotel_booking_buyer_fees[{{$key}}][per_person]" value="on" @if($buyer_fee['per_person'] ?? '') checked @endif >
                                                    {{__("Price per person")}}
                                                </label>
                                            </div>
                                            <div class="col-md-1">
                                    ...
                                    <div class="col-md-5">
                                        @if(!empty($languages) && setting_item('site_enable_multi_lang') && setting_item('site_locale'))
                                            @foreach($languages as $language)
                                                ...
                                                <div class="g-lang">
                                                    <div class="title-lang">{{$language->name}}</div>
                                                    <input type="text" __name__="hotel_booking_buyer_fees[__number__][name{{$key}}]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                                    <input type="text" __name__="hotel_booking_buyer_fees[__number__][desc{{$key}}]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                                </div>

                                            @endforeach
                                        @else
                                            <input type="text" __name__="hotel_booking_buyer_fees[__number__][name]" class="form-control" value="" placeholder="{{__('Fee name')}}">
                                            <input type="text" __name__="hotel_booking_buyer_fees[__number__][desc]" class="form-control" value="" placeholder="{{__('Fee desc')}}">
                                        @endif
                                    </div>
                                    <div class="col-md-3">
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <p class="form-group-desc">{{__('Vendor config for hotel')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
...
@if(is_default_lang())
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="hotel_deposit_enable" value="1" @if(setting_item('hotel_deposit_enable')) checked @endif > {{__('Yes, please enable it')}}</label>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <input type="number" name="hotel_deposit_amount" class="form-control" step="0.1" value="{{old('hotel_deposit_amount',setting_item('hotel_deposit_amount'))}}" >
                                        <select name="hotel_deposit_type"  class="form-control">
                                            <option value="fixed">{{__("Fixed")}}</option>
                                            <option @if(old('hotel_deposit_type',setting_item('hotel_deposit_type')) == 'percent') selected @endif value="percent">{{__("Percent")}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <select name="hotel_deposit_fomular" class="form-control" >
                                        <option value="default" {{($settings['hotel_deposit_fomular'] ?? '') == 'default' ? 'selected' : ''  }}>{{__('Default')}}</option>
                                        <option value="deposit_and_fee" {{ ($settings['hotel_deposit_fomular'] ?? '') == 'deposit_and_fee' ? 'selected' : ''  }}>{{__("Deposit amount + Buyer free")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__("Disable hotel module?")}}</h3>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-title"><strong>{{__("Disable hotel module")}}</strong></div>
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="hotel_disable" value="1" @if(setting_item('hotel_disable')) checked @endif > {{__('Yes, please disable it')}}</label>
                        </div>
                    </div>
                </div>
            </div>
