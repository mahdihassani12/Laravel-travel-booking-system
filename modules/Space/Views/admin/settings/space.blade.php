                ...
                <div class="form-group d-none">
                    ...
                    <div class="form-controls">
                        <select name="space_layout_search" class="form-control" >
                            <option value="normal" {{ ($settings['space_layout_search'] ?? '') == 'normal' ? 'selected' : ''  }}>{{__("Normal Layout")}}</option>
                            <option value="map" {{($settings['space_layout_search'] ?? '') == 'map' ? 'selected' : ''  }}>{{__('Map Layout')}}</option>
                        </select>
                    </div>
                </div>
                @endif
                    ...
                    <div class="tab-content" >
                        <div class="tab-pane active" id="seo_1">
                            <div class="form-group" >
                                ...
                                <input type="text" name="space_page_list_seo_title" class="form-control" placeholder="{{__("Enter title...")}}" value="{{ setting_item_with_lang('space_page_list_seo_title',request()->query('lang'))}}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Seo Description")}}</label>
                                <input type="text" name="space_page_list_seo_desc" class="form-control" placeholder="{{__("Enter description...")}}" value="{{setting_item_with_lang('space_page_list_seo_desc',request()->query('lang'))}}">
                            </div>
                            @if(is_default_lang())
                        ...
                        <div class="tab-pane" id="seo_2">
                            <div class="form-group">
                                ...
                                <input type="text" name="space_page_list_seo_share[facebook][title]" class="form-control" placeholder="{{__("Enter title...")}}" value="{{$seo_share['facebook']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Facebook Description")}}</label>
                                <input type="text" name="space_page_list_seo_share[facebook][desc]" class="form-control" placeholder="{{__("Enter description...")}}" value="{{$seo_share['facebook']['desc'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                        ...
                        <div class="tab-pane" id="seo_3">
                            <div class="form-group">
                                ...
                                <input type="text" name="space_page_list_seo_share[twitter][title]" class="form-control" placeholder="{{__("Enter title...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            <div class="form-group">
                                <label class="control-label">{{__("Twitter Description")}}</label>
                                <input type="text" name="space_page_list_seo_share[twitter][desc]" class="form-control" placeholder="{{__("Enter description...")}}" value="{{$seo_share['twitter']['title'] ?? "" }}">
                            </div>
                            @if(is_default_lang())
                                <div class="form-group form-group-image">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <select name="space_booking_type" class="form-control">
                                    <option value="by_day" {{($settings['space_booking_type'] ?? '') == 'by_day' ? 'selected' : ''  }}> {{__("Space by day")}}</option>
                                    <option value="by_night" {{($settings['space_booking_type'] ?? '') == 'by_night' ? 'selected' : ''  }}> {{__("Space by night")}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-sm-8">
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-controls">
                            <label><input type="checkbox" name="space_deposit_enable" value="1" @if(setting_item('space_deposit_enable')) checked @endif > {{__('Yes, please enable it')}}</label>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="space_deposit_type"  class="form-control">
                                            <option value="fixed">{{__("Fixed")}}</option>
                                            <option @if(old('space_deposit_type',setting_item('space_deposit_type')) == 'percent') selected @endif value="percent">{{__("Percent")}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <select name="space_deposit_fomular" class="form-control" >
                                        <option value="default" {{($settings['space_deposit_fomular'] ?? '') == 'default' ? 'selected' : ''  }}>{{__('Default')}}</option>
                                        <option value="deposit_and_fee" {{ ($settings['space_deposit_fomular'] ?? '') == 'deposit_and_fee' ? 'selected' : ''  }}>{{__("Deposit amount + Buyer free")}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
