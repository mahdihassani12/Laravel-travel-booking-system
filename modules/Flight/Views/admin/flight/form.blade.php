    ...
    <div class="panel-body">
            <div class="row">
                <div class="form-group col-lg-6">
                    <label>{{__("Name")}}</label>
                    <input type="text" value="{{$row->title}}" placeholder="{{__("Name")}}" name="title" class="form-control">
                </div>
                <div class="form-group col-lg-6">
                    <label>{{__("Code")}}</label>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="departure_time" class="form-control has-datetimepicker" value="{{$row->departure_time}}" placeholder="{{__("Departure time")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Arrival time")}}</label>
                        <input type="text" name="arrival_time" class="form-control has-datetimepicker" value="{{$row->arrival_time}}" placeholder="{{__("Arrival time")}}">
                    </div>
                </div>
