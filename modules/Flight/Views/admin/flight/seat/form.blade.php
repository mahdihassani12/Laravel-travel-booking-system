...
<div class="col-md-12">
    <div class="form-group">
        ...
        <input type="number" required value="{{$row->baggage_check_in ?? 1}}" min="1" max="100" placeholder="{{__("Number")}}" name="max_passengers" class="form-control">
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label>{{__("Baggage Cabin")}} <span class="text-danger">*</span></label>
        <input type="number" required value="{{$row->baggage_cabin ?? 1}}" min="1" max="100" placeholder="{{__("Number")}}" name="max_passengers" class="form-control">
    </div>
</div>